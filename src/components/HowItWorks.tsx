  ...
  return (
    <div className="mt-20 bg-[#F8F8F8] py-12" id="how-it-works">
      ...
      >
        ...
        <div className="mx-4 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:mx-0 lg:grid-cols-3 xl:gap-10">
          {steps?.map((step, index) => (
            <div
              key={index}
              className="flex flex-col items-center rounded-[20px] bg-white px-4 py-4 shadow-md lg:items-start lg:rounded-[30px]"
              data-aos="fade-up"
            ...
            >
              ...
              />
              <h3 className="mt-4 text-center font-sans text-lg font-semibold text-[#083D6A] sm:text-xl lg:text-start lg:text-2xl">
                {step.title}
              </h3>
              <span className="mt-2 block text-center text-sm text-[#626262] sm:text-base lg:text-start lg:text-lg">
                {step.description}
              </span>
            </div>
          ))}
