    ...
    >
      <div className="mx-6 mt-0 lg:mx-0 lg:mt-28 lg:px-0 lg:pl-0">
        ...
        <div data-aos="fade-right" className="">
          ...
          <h1 className="gradient-text m-0 py-0 pb-1 text-2xl sm:text-3xl lg:py-2 lg:text-4xl xl:text-[44px]">
            Monitoring
          </h1>
        </div>
      </div>
      <div className="mt-12 grid grid-cols-12 gap-0 lg:mx-0 lg:gap-12 xl:gap-8">
        ...
        <div className="col-span-12 mt-16 lg:col-span-6 lg:mt-0">
          ...
          >
            <p className="text-base text-[#626262] sm:text-lg lg:!text-xl">
            ...
            <p className="mt-4 text-base text-[#626262] sm:text-lg lg:!text-xl">
